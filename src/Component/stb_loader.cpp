...
Texture* Load2DTextureFromFile(Device* device, ID3D12GraphicsCommandList* cmdList, const char* filepath, UploadBuffer* tmpUpload) {
	...
	result = new Texture(device, width, height, format, TextureDimension::Tex2D, 1, 0, Texture::TextureUsage::GenericColor, D3D12_RESOURCE_STATE_COPY_DEST);
